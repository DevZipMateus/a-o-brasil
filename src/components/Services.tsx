        ...
        >
          {services.map((s, i) => (
            <motion.div
              ...
              variants={fadeInUp}
              custom={i}
              className="flex items-center gap-4 bg-card rounded-lg p-5 shadow-card border border-border hover:shadow-elevated hover:border-accent/30 transition-all duration-300"
            >
