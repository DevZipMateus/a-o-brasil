        ...
        >
          {services.map((s, i) => (
            ...
            >
              ...
              <div>
                <span className="font-heading text-lg font-semibold text-foreground block">{s.name}</span>
                <span className="text-muted-foreground text-xs uppercase tracking-widest">Serviço</span>
              </div>
            </motion.div>
          ))}
        </motion.div>
